...
6. **Screenshot obrigatório quando rodando no PC com Chrome** — salvar de fato em `concorrentes/img/YYYY-MM-DD/` (resolver o mecanismo de salvar o arquivo antes de rodar oficial; não é best-effort quando o Chrome está disponível). OLHAR a imagem antes de escrever a leitura da peça.
